...
<div class="conferenceplus item">
	...
	else
	{
		...
		echo JText::_('COM_CONFERENCEPLUS_HEADTEXTSUBMIT_TICKET');
	}

	?>


	<?php echo JText::_('COM_CONFERENCEPLUS_TICKET_PRETEXT');?>
	
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">

			<form action="index.php?option=com_conferenceplus&view=ticket&layout=dobuy&Itemid=<?php echo $Itemid;?>" method="post" id="adminForm" role="form">
